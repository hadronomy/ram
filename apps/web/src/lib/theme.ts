/* https://github.com/shikijs/shiki/blob/main/packages/core/src/textmate/normalize-theme.ts */

import type { ThemeRegistrationAny, ThemeRegistrationResolved } from '@shikijs/types'
