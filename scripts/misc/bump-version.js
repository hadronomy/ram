// Got from https://github.com/ram/ram/blob/8a2964aa7cc7b4fd1045952755d45d883e7df914/scripts/misc/bump-version.js
...
async function getCurrentVersion() {
  const pkgPath = path.resolve(REPO_ROOT, './packages/ram/package.json');
...
if (process.env.CI) {
  ...
  fsExtra.writeFileSync(
    path.resolve(REPO_ROOT, 'ram-version.txt'),
    newVersion,
  );
}