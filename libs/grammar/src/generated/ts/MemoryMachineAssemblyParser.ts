import type { MemoryMachineAssemblyListener } from './MemoryMachineAssemblyListener.js';

import type { MemoryMachineAssemblyVisitor } from './MemoryMachineAssemblyVisitor.js';
...
export class MemoryMachineAssemblyParser extends antlr.Parser {
  ...
  public line(): LineContext {
    const localContext = new LineContext(this.context, this.state);
  ...
  public label_definition(): Label_definitionContext {
    const localContext = new Label_definitionContext(this.context, this.state);
  ...
  public instruction(): InstructionContext {
    const localContext = new InstructionContext(this.context, this.state);
  ...
  public comment(): CommentContext {
    const localContext = new CommentContext(this.context, this.state);
  ...
  public direct(): DirectContext {
    const localContext = new DirectContext(this.context, this.state);
  ...
  public indirect(): IndirectContext {
    const localContext = new IndirectContext(this.context, this.state);
  ...
  public immediate(): ImmediateContext {
    const localContext = new ImmediateContext(this.context, this.state);
  ...
  public accessor(): AccessorContext {
    const localContext = new AccessorContext(this.context, this.state);
